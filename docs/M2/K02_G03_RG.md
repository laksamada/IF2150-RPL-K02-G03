...
| :--- | :--- | :--- | :--- |
| *KNF01* | *R02* | *Availability* | *Sistem dapat diakses kapanpun dan dimanapun agar sistem selalu siap untuk menerima laporan-laporan dari pengguna.* |
| *KNF02* | *R08* | *Portability* | *Sistem harus dapat meneruskan hasil dari laporan yang ada di database sistem kepada pemerintah daerah.* |
| ... | ... | ... | ... |
