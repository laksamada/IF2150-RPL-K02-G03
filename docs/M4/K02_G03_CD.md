...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *Pelapor* | *idPelapor, namaPelapor* | *konfirmasiSimpanLaporan(), terimaNotifikasi(), bukaRiwayatLaporan(Laporan)* |
...
| *C06* | *Fasilitas* | *idFasilitas, namaFasilitas* | *getLaporan(), cariFasilitas(keyword), getDetailFasilitas()* |
| *C07* | *Verifikasi* | *idVerifikasi, keputusan, catatanAlasan, waktuVerifikasi* | *simpanVerifikasi(), tahanLaporan(), teruskanKePemerintah()* |
