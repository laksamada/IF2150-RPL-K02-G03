...
<br>
<p align="center">
<img alt="Contoh Activity Diagram" src="./assets/diagram_silembur.png" width="70%">
</p>
<p align="center">
<i>Gambar 1. Use Case Diagram silembur</i>
</p>
<br>
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Masyarakat umum membuka menu Laporan Pengguna Lain* | *Sistem menampilkan beberapa laporan yang sudah ditulis oleh pengguna lain yang mencakup  judul, foto, dan lokasi laporan* |
| 2 | *Masyarakat umum memilih laporan yang ingin dilihat* | *Sistem menampilkan laporan secara detail, yang mencakup judul, deksripsi, foto, dan riwayat pengerjaan laporan* |

**Skenario Alternatif 1: Laporan**
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Masyarakat umum membuka menu Laporan yang telah dibuat* | *Sistem menampilkan beberapa laporan yang sudah ditulis oleh pengguna yang mencakup  judul, foto, dan lokasi laporan* |
| 2 | *Masyarakat umum memilih laporan yang ingin dilihat* | *Sistem menampilkan laporan secara detail, yang mencakup judul, deksripsi, foto, dan riwayat pengerjaan laporan terurut dari terawal hingga terakhir* |
...
| No | Aksi Aktor | Reaksi Perangkat Lunak |
| :--- | :--- | :--- |
| 1 | *Admin/Pemerintah daerah membuka menu laporan yang dikirim pengguna* | *Sistem menampilkan list laporan-laporan * |
| 2 | *Pemerintah daerah menyaring laporan yang sudah terverifikasi* | *Sistem dapat memberikan filter pada list laporan-laporan. Seperti filter prioritas, lokasi, kategori kerusakan, dll* |
