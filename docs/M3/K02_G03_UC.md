...
| *KF03* | *R01* | *Jika tersedia layanan GPS, sistem harus mengambil data lokasi laporan secara otomatis; jika tidak, sistem harus menyediakan input lokasi manual melalui integrasi peta* |
